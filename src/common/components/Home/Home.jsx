  ...
  >
    ...
    <div className="flex flex-col hero-content text-center text-neutral-content">
      ...
      <div  className="text-wrap h-screen w-full  flex flex-col flex-wrap justify-center items-center ">
        <h3 className="text-yellow-300 text-6xl m-2 tracking-widest p-2">Welcome to <span className="text-7xl text-gray-900">BlogsWeb</span>  Your One-Stop Destination for Freshness and Quality!</h3>
        <p className="text-balance text-gray-100 text-2xl tracking-widest italic  p-2">At BlogsWeb, we believe that great meals start with great ingredients. As your trusted neighborhood grocer, we're dedicated to providing you with the finest selection of fresh produce, pantry essentials, and specialty items to make every meal memorable.</p>
      </div>
        ...
        {/* <p className="text-wrap h-screen w-full  flex flex-col flex-wrap justify-center items-center ">
          <h3 className="text-warning text-6xl m-2 tracking-widest p-2">Welcome to <span className="text-7xl text-yellow-900">BlogsWeb</span>  Your One-Stop Destination for Freshness and Quality!</h3>
          <p className="text-balance text-2xl tracking-widest italic  p-2">At BlogsWeb, we believe that great meals start with great ingredients. As your trusted neighborhood grocer, we're dedicated to providing you with the finest selection of fresh produce, pantry essentials, and specialty items to make every meal memorable.</p>
        </p> */}
