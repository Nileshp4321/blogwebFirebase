    ...
    <div>
          ...
          <ul className="space-y-2 font-medium">
            ...
            >
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Histroy</span>
              </a>
            </li> */}
            <li>
              <a
              ...
              >
                <svg
                  className="flex-shrink-0 w-5 h-5 m-2 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 18 16"
      ...
      <div className="p-4 sm:ml-64">
        {/* {activeComponent === "Cart" && (
          <Cart setaActiveComponent={setaActiveComponent} />
        )} */}
        {activeComponent === "Products" && (
          <ProductItems setaActiveComponent={showComponent} />
        )}
         {activeComponent === "ConsumerAdd" && (
          <ConsumerAdd setaActiveComponent={showComponent} />
        )}
         {/* {activeComponent === "Histroy" && (
          <OrderHistroy setaActiveComponent={showComponent} />
        )} */}
      </div>
    </div>
  );
